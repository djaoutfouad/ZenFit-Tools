...
export const CATEGORIES_CATALOG: CategoryMeta[] = [
  {
    ...
    shortDescription: 'Evidence-based mathematical models for caloric expenditure, estimated thermogenesis, nutrient partitioning, and fasting physiology.',
...
export const CALCULATORS_CATALOG: CalculatorMeta[] = [
  {
    ...
    shortDescription: 'Estimate your Total Daily Energy Expenditure (TDEE) and basal metabolic rate using published Mifflin-St Jeor and Katch-McArdle equations.',
    category: 'metabolism',
    badge: 'Core Metric',
    readTime: '5 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    shortDescription: 'Estimate balanced protein, carbohydrate, and dietary fat ratios tailored to fat loss, muscle hypertrophy, or ketogenic protocols.',
    category: 'metabolism',
    badge: 'Nutrition Suite',
    readTime: '6 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    shortDescription: 'Empirical body circumference method adopted by the United States Department of Defense for estimated body composition assessment.',
  ...
  },
  {
    ...
    readTime: '5 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=600&q=80',
    personaRole: 'Strength Biomechanics & 1RM Standards Coach',
  ...
  },
  {
    ...
    readTime: '4 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1576243345690-4e4b79b63288?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    readTime: '4 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1552674605-db6ffd4facb5?auto=format&fit=crop&w=600&q=80',
    personaRole: 'Endurance & Marathon Pacing Lead',
    formulaSummary: 'Riegel Fatigue Model: T2 = T1 × (D2 / D1)^1.06',
    detailedFormulaHtml: `
      <p class="mb-3"><strong>Pete Riegel Endurance Equation:</strong></p>
      <p class="text-slate-800 font-mono bg-slate-100 p-3 rounded-xl mb-4">T2 = T1 × (D2 / D1)<sup>1.06</sup></p>
      <p class="text-slate-700">Where T1 is your baseline race time, D1 is baseline distance, D2 is target distance, and 1.06 is the empirical fatigue exponent across human aerobic events from 1,500m to ultra-marathons.</p>
    `,
    scientificGuidelines: [
  ...
  },
  {
    ...
    readTime: '5 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1509114397022-ed747cca3f65?auto=format&fit=crop&w=600&q=80',
    personaRole: 'Circadian Chronobiology & Metabolic Fasting Lead',
  ...
  },
  {
    ...
    readTime: '3 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    readTime: '4 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1593095948071-474c5cc2989d?auto=format&fit=crop&w=600&q=80',
    personaRole: 'Ergogenic Pharmacokinetics & Cellular Saturation Advisor',
  ...
  },
  {
    ...
    badge: 'Anthropometry',
    readTime: '4 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1584036561566-baf8f5f1b144?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    readTime: '4 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    readTime: '5 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    readTime: '5 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=600&q=80',
  ...
  },
  {
    ...
    personaRole: 'Concurrent Hypertrophy & Kinetic Partitioning Coach',
  ...
  },
  {
    ...
    shortDescription: 'Calculate Karvonen Heart Rate Reserve zones factoring individual resting pulse for aerobic training guidance.',
    category: 'performance',
    badge: 'Cardio Physiology',
    readTime: '4 min read',
    personaImageUrl: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?auto=format&fit=crop&w=600&q=80',
    personaRole: 'Cardiopulmonary Reserve & Karvonen Analyst',
